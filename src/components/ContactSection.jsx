          ...
          <div className="bg-white rounded-[28px] sm:rounded-[36px] p-6 sm:p-8 lg:p-10 shadow-lg border border-stone-200/80">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-stretch">
              ...
              <div className="lg:col-span-6 flex flex-col justify-between space-y-4">
                ...
                <div className="flex items-center justify-between p-3.5 sm:p-4 rounded-2xl border border-stone-200/60 hover:border-stone-300/80 transition-colors">
                  ...
                  <a
                    ...
                    className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-stone-50/80 hover:bg-emerald-50 text-stone-500 hover:text-[#1ca350] border border-stone-200/60 flex items-center justify-center transition-all shadow-sm flex-shrink-0 group"
                  >
                    <ExternalLink
                      size={17}
                ...
                <div className="p-3.5 sm:p-4 rounded-2xl border border-stone-200/60 hover:border-stone-300/80 transition-colors flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                  <div>
                    <span className="text-[11px] font-bold text-stone-400 uppercase tracking-wider block">
                      Social Channels
                    </span>
