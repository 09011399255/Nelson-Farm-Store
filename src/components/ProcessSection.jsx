          ...
          {QUALITY_PILLARS.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className="bg-[#0b3d22] rounded-2xl sm:rounded-[32px] p-5 sm:p-7 border border-emerald-500/20 shadow-xl hover:shadow-2xl hover:border-[#a3e635]/60 transition-all duration-300 group flex flex-col justify-between h-full">
                  <div>
                    {/* Photo Container */}
                    <div className="relative overflow-hidden rounded-xl sm:rounded-2xl mb-5 sm:mb-6 shadow-md bg-black/20">
                      <img
