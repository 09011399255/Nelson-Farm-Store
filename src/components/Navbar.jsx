              ...
              <div className="text-center text-xs text-gray-500 space-y-1.5">
                ...
                <div className="flex items-center justify-center gap-3 pt-2">
                  <a
                    ...
                    className="w-8 h-8 rounded-lg bg-gray-100 hover:bg-[#E4405F] text-gray-600 hover:text-white flex items-center justify-center transition-colors"
                  >
                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  ...
                  <a
                    ...
                    className="w-8 h-8 rounded-lg bg-gray-100 hover:bg-black text-gray-600 hover:text-white flex items-center justify-center transition-colors"
                  >
                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  ...
                  <a
                    ...
                    className="w-8 h-8 rounded-lg bg-gray-100 hover:bg-[#1877F2] text-gray-600 hover:text-white flex items-center justify-center transition-colors"
                  >
                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
