...
import { ArrowRight, ShieldCheck, Heart, Check, UserCheck } from "lucide-react";
          ...
          <div className="lg:col-span-7 flex flex-col justify-between">
            <div>
              ...
              <p className="text-stone-600 text-sm sm:text-base leading-relaxed mb-4 font-normal">
                ...
                raising quality livestock and supplying wholesome farm products.
                We are building a trusted agricultural brand centred around
                responsible care, consistency, and nutritional value.
              </p>
                ...
                <div className="space-y-5">
                  <div className="flex items-start gap-3.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-emerald-200/80 mt-0.5 leading-relaxed font-normal">
                        Certified animal scientists conducting routine wellness
                        checks.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-emerald-200/80 mt-0.5 leading-relaxed font-normal">
                        Four bio-secure commercial divisions with pure borehole
                        water.
                      </p>
                    </div>
                  </div>
