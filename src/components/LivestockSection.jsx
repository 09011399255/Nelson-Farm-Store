          ...
          {LIVESTOCK_SECTORS.map((sector, index) => {
            ...
            return (
              ...
              >
                ...
                <article className="bg-white rounded-2xl sm:rounded-3xl border border-emerald-950/10 shadow-sm hover:shadow-farm-lg transition-all duration-300 overflow-hidden">
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12 items-center p-5 sm:p-10 lg:p-12">
                    {/* Image Column (6 cols) */}
                    <div
                      className={`lg:col-span-6 ${isReverse ? "lg:order-2" : ""}`}
